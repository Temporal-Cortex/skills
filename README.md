...
**v0.6.0** · February 2026 · [Changelog](CHANGELOG.md) · **Website:** [temporal-cortex.com](https://temporal-cortex.com)
...
```bash
npx @temporal-cortex/cortex-mcp@0.6.0 auth google     # Google Calendar
npx @temporal-cortex/cortex-mcp@0.6.0 auth outlook    # Microsoft Outlook
npx @temporal-cortex/cortex-mcp@0.6.0 auth caldav     # CalDAV (iCloud, Fastmail)
```
